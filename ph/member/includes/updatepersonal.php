...
$member_insert = "UPDATE member SET f_name = '$f_name_bb', l_name='$l_name_bb', gender='$gender_bb', phone_no='$phone_no_bb', dob='$dob_bb', address='$address_bb', injuries='$injuries_bb' WHERE username = '$username';";
