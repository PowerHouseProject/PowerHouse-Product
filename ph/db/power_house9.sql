...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2022 at 07:36 AM
...
CREATE TABLE `1m_package_progress` (
  ...
  `bmi_values` varchar(255) NOT NULL,
  `bf_values` varchar(255) NOT NULL
...
CREATE TABLE `6m_package_progress` (
  `package_id` int(10) NOT NULL,
  `member_id` int(10) NOT NULL,
  `attendance` varchar(800) NOT NULL,
  `bmi_values` varchar(255) NOT NULL,
  `bf_values` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 36, '[[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null],[null,null,null,null,null]]', '[\"20\",\"21\",\"20\",\"22\"]', '[null,null,null,null,null,null,null,null,null,null,null,null]');
...
INSERT INTO `admin` (`username`, `admin_id`, `image`, `cover_image`, `f_name`, `l_name`, `address`) VALUES
('admin', 0, 'thusitha.jpg', 'gtgt.jpg', 'Bimsara', 'Kulasekara', 'No.118, Vijayarajadahana, Mirigama');
...
(2, 1, '2021-12-04', 'All day'),
(3, 1, '2021-12-07', 'Morning'),
(4, 1, '2021-12-05', 'Evening'),
(10, 1, '2021-12-08', 'Morning'),
(11, 1, '2021-12-11', 'All day'),
(13, 2, '2022-03-23', 'All day');
...
(11, 1, 4, '2021-12-07', '10:00:00'),
(12, 1, 6, '2021-12-07', '08:00:00'),
(13, 1, 4, '2021-12-07', '08:00:00'),
(14, 1, 5, '2021-12-07', '08:00:00'),
(15, 1, 4, '2021-12-07', '08:00:00'),
(16, 1, 5, '2021-12-07', '08:00:00'),
(17, 1, 36, '2021-12-10', '06:00:00'),
(45, 1, 36, '2022-02-08', '10:00:00'),
(47, 1, 36, '2022-03-18', '18:00:00');
...
(1, 'hiran', 'Hiran ', 'Gamage', ' 7 B Tower Bldg 25 Station Road, 04 , Mirigama', 785619959, '1999-05-01', 'male', '', 1, '2021-09-27 12:22:43', 'hiran.jpg', 'default_cover.jpg'),
(2, 'duminda', 'Duminda ', 'Jayasinghe', '27, Holy Emmanuel Church Road , Mirigama', 785619959, '1990-01-12', 'male', '', 1, '2021-09-27 12:22:43', 'duminda.jpg', 'default_cover.jpg'),
(3, 'herath', 'Herath', 'Withanage ', ' 8 B Tower Bldg 25 Station Road, 04 , Mirigama', 785619959, '1999-05-01', 'male', '', 0, '2021-09-27 12:22:43', 'herath.jpg', 'default_cover.jpg'),
(4, 'udaya', 'Udaya ', 'Wickrema', '27, Holy Emmanuel Church Road , Mirigama', 785619959, '1994-01-12', 'male', '', 1, '2021-09-27 12:22:43', 'udaya.jpg', 'default_cover.jpg'),
(5, 'umashi', 'Umashi ', 'Gamage', ' 8 B Tower Bldg 25 Station Road, 04 , Mirigama', 785619959, '1999-05-01', 'female', '', 1, '2021-09-27 12:22:43', 'umashi.jpg', 'default_cover.jpg'),
(6, 'hiranya', 'Hiranya ', 'Iriyagolla', '27, Holy Emmanuel Church Road , Mirigama', 785619959, '1998-01-12', 'female', '', 1, '2021-09-27 12:22:43', 'hiranya.jpg', 'default_cover.jpg'),
(36, 'pamodha98', 'Pamodha', 'Mahagamage', 'Mirigam', 750000001, '1998-11-23', 'male', '', 2, '2021-11-22 12:47:31', 'default_profile.png', 'default_cover.jpg'),
(37, 'samplemember', 'amila', 'rox', 'Mirigama', 1234567891, '2000-10-20', 'male', '', 0, '2022-01-11 09:29:16', '', 'default_cover.jpg');
...
(1, 3, 3, '2021-10-09', 0, 0, 'valid'),
(2, 1, 1, '2021-10-09', 0, 0, 'valid'),
(25, 2, 6, '2021-10-09', 0, 0, 'valid'),
(26, 4, 12, '2021-10-09', 0, 0, 'valid'),
(27, 5, 1, '2021-10-09', 0, 0, 'invalid'),
(28, 6, 1, '2021-10-09', 0, 0, 'valid'),
(29, 36, 12, '2021-11-22', 0, 0, 'valid'),
(30, 37, 1, '2022-01-11', 0, 0, 'valid');
...
(1, 3, '2021-10-09', 'Renew Membership', 7500, 1, 'online'),
(2, 1, '2021-10-09', 'Renew Membership', 13500, 2, 'online'),
(23, 36, '2021-11-22', 'Renew Membership', 25000, 1, 'online'),
(24, 36, '2021-12-11', 'Renew Membership', 2500, 1, 'Online'),
(26, 36, '2021-12-19', 'Renew Membership', 2500, 1, 'Online'),
(43, 36, '2021-12-19', 'Trainer Assignment', 5000, 1, 'Online'),
(45, 36, '2022-03-18', 'Trainer Assignment', 5000, 1, 'Online'),
(46, 36, '2022-03-18', 'Trainer Assignment', 5000, 1, 'Online'),
(47, 36, '2022-03-18', 'Trainer Assignment', 5000, 1, 'Online'),
(48, 36, '2022-03-18', 'Trainer Assignment', 5000, 1, 'Online'),
(49, 36, '2022-03-18', 'Trainer Assignment', 4500, 2, 'Online');
...
(20, 'pamodhamahagamage98@gmail.com', 'c477b9b24ef6d104', '$2y$10$OhptPmixr9zU0XHWOxWRu.9ABzug050fX0KztpwAsgBeQXVlO4wPG', '1648046218');
...
(10, 36, 2, 'He is a good trainer', '2022-03-21', 3, 0);
...
CREATE TABLE `schedule` (
  ...
  `member_id` int(11) NOT NULL,
  `day1_ex1` varchar(255) NOT NULL,
  `day2_ex1` varchar(255) DEFAULT NULL,
  `day3_ex1` varchar(255) DEFAULT NULL,
  `day4_ex1` varchar(255) DEFAULT NULL,
  `day5_ex1` varchar(255) DEFAULT NULL,
  `day6_ex1` varchar(255) DEFAULT NULL,
  `day7_ex1` varchar(255) DEFAULT NULL,
  `day1_ex2` varchar(255) DEFAULT NULL,
  `day2_ex2` varchar(255) DEFAULT NULL,
  `day3_ex2` varchar(255) DEFAULT NULL,
  `day4_ex2` varchar(255) DEFAULT NULL,
  `day5_ex2` varchar(255) DEFAULT NULL,
  `day6_ex2` varchar(255) DEFAULT NULL,
  `day7_ex2` varchar(255) DEFAULT NULL,
  `day1_ex3` varchar(255) DEFAULT NULL,
  `day2_ex3` varchar(255) DEFAULT NULL,
  `day3_ex3` varchar(255) DEFAULT NULL,
  `day4_ex3` varchar(255) DEFAULT NULL,
  `day5_ex3` varchar(255) DEFAULT NULL,
  `day6_ex3` varchar(255) DEFAULT NULL,
  `day7_ex3` varchar(255) DEFAULT NULL,
  `day1_ex4` varchar(255) DEFAULT NULL,
  `day2_ex4` varchar(255) DEFAULT NULL,
  `day3_ex4` varchar(255) DEFAULT NULL,
  `day4_ex4` varchar(255) DEFAULT NULL,
  `day5_ex4` varchar(255) DEFAULT NULL,
  `day6_ex4` varchar(255) DEFAULT NULL,
  `day7_ex4` varchar(255) DEFAULT NULL,
  `day1_ex5` varchar(255) DEFAULT NULL,
  `day2_ex5` varchar(255) DEFAULT NULL,
  `day3_ex5` varchar(255) DEFAULT NULL,
  `day4_ex5` varchar(255) DEFAULT NULL,
  `day5_ex5` varchar(255) DEFAULT NULL,
  `day6_ex5` varchar(255) DEFAULT NULL,
  `day7_ex5` varchar(255) DEFAULT NULL,
  `day1_ex6` varchar(255) DEFAULT NULL,
  `day2_ex6` varchar(255) DEFAULT NULL,
  `day3_ex6` varchar(255) DEFAULT NULL,
  `day4_ex6` varchar(255) DEFAULT NULL,
  `day5_ex6` varchar(255) DEFAULT NULL,
  `day6_ex6` varchar(255) DEFAULT NULL,
  `day7_ex6` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `trainer_receviables` (
  ...
  `trainer_id` int(10) NOT NULL,
  `assignment_count` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('$2y$10$E71wJCxqjX7qpMhOW5yxVuoX892BsRPNj3HQdE.4VG3BOHngzV6Oy', 'pamodha98', 'pamodhamahagamage98@gmail.com', 'member'),
('$2y$10$E71wJCxqjX7qpMhOW5yxVuoX892BsRPNj3HQdE.4VG3BOHngzV6Oy', 'samplemember', 'pamodhamahagamage98@gmail.com', 'member'),
...
--
ALTER TABLE `book`
  MODIFY `book_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `member`
  MODIFY `member_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `membership`
--
ALTER TABLE `membership`
  MODIFY `membership_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `payment`
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `trainer_receviables`
  MODIFY `tr_rece_id` int(10) NOT NULL AUTO_INCREMENT;
