...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2021 at 04:54 PM
...
(36, 'pamodha98', 'Pamodha', 'Mahagamage', 'Mirigama', 1234567891, '1998-11-23', 'male', 'No ', 1, '2021-11-22 12:47:31', '', 'default_cover.jpg');
...
(23, 36, '2021-11-22', 25000, 1, 'online'),
(24, 36, '2021-12-11', 2500, 1, 'Online'),
(25, 36, '2021-12-19', 0, 1, 'Online'),
(26, 36, '2021-12-19', 2500, 1, 'Online'),
(43, 36, '2021-12-19', 5000, 1, 'Online');
...
--
ALTER TABLE `book`
  MODIFY `book_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `member`
  MODIFY `member_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `membership`
--
ALTER TABLE `membership`
  MODIFY `membership_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
