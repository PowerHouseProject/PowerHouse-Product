...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2021 at 07:22 PM
...
INSERT INTO `admin` (`username`, `user_id`, `password`, `email`) VALUES
('bimsara', 0, '$2y$10$g5Ht3jYzowOdnjVGR8ro4.Xs.x3SWsTI5ja4q5Dzy8U5YAVgkEU9.', 'kulasekarakmbs@gmail.com');
...
INSERT INTO `member` (`member_id`, `f_name`, `l_name`, `address`, `phone_no`, `dob`, `gender`, `injuries`, `assign_trainer`, `email`, `username`, `password`, `joined_date`, `image`) VALUES
(1, 'Hiran ', 'Gamage', ' 7 B Tower Bldg 25 Station Road, 04 , Mirigama', 785619959, '1999-05-01', 'male', '', 1, 'kulasekarakmbs@gmail.com', 'hiran', '1234', '2021-09-27 12:22:43', 'hiran.jpg'),
(2, 'Duminda ', 'Jayasinghe', '27, Holy Emmanuel Church Road , Mirigama', 785619959, '1990-01-12', 'male', '', 1, 'kulasekarakmbs@gmail.com', 'duminda', '1234', '2021-09-27 12:22:43', 'duminda.jpg'),
(3, 'Herath', 'Withanage ', ' 8 B Tower Bldg 25 Station Road, 04 , Mirigama', 785619959, '1999-05-01', 'male', '', 0, 'kulasekarakmbs@gmail.com', 'herath', '1234', '2021-09-27 12:22:43', 'herath.jpg'),
(4, 'Udaya ', 'Wickrema', '27, Holy Emmanuel Church Road , Mirigama', 785619959, '1994-01-12', 'male', '', 1, 'kulasekarakmbs@gmail.com', 'udaya', '1234', '2021-09-27 12:22:43', 'udaya.jpg'),
(5, 'Umashi ', 'Gamage', ' 8 B Tower Bldg 25 Station Road, 04 , Mirigama', 785619959, '1999-05-01', 'female', '', 1, 'kulasekarakmbs@gmail.com', 'umashi', '1234', '2021-09-27 12:22:43', 'umashi.jpg'),
(6, 'Hiranya ', 'Iriyagolla', '27, Holy Emmanuel Church Road , Mirigama', 785619959, '1998-01-12', 'female', '', 1, 'kulasekarakmbs@gmail.com', 'hiranya', '1234', '2021-09-27 12:22:43', 'hiranya.jpg'),
(27, 'xyz', 'abc', 'qpr', 1234567891, '2000-10-20', 'female', 'xczxvsdxv', 1, 'abc@gmail.com', 'powehouse123', '$2y$10$nBrKZuY.2NUoEGEy5BGat.ykC4uASKTkgTBD6t6PI9CPUxijSQH6S', '2021-10-06 09:59:15', '');
...
(14, 27, '2021-10-06', 7000, 2, 'online');
...
(8, 'kulasekarakmbs@gmail.com', 'b175d170b00e9fd0', '$2y$10$KXkbR3mlL/Wk4BnRZt9icuhNSrULFoMWMKCdt5AjtE3UX6yzP1rpm', '1633353663');
...
--
ALTER TABLE `member`
  MODIFY `member_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `membership`
--
ALTER TABLE `membership`
  MODIFY `membership_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
ALTER TABLE `payment`
  ...
  ADD CONSTRAINT `payment_ibfk_2` FOREIGN KEY (`trainer_id`) REFERENCES `trainer` (`trainer_id`);
