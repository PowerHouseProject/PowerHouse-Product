...
$update_accountant = "UPDATE accountant SET f_name = '$f_name_bb', l_name='$l_name_bb', gender='$gender_bb', phone_no='$phone_no_bb',  address='$address_bb' WHERE username = '$username';";

$result1 = mysqli_query($conn, $update_accountant);
